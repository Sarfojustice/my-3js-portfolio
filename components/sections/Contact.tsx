...
export default function Contact() {
  return (
    <footer id="contact" className="py-20 md:py-24 px-6 max-w-4xl mx-auto relative z-10 text-center">
      ...
      <div className="pt-12 border-t border-white/5 text-gray-600 text-[10px] font-mono tracking-widest uppercase">
        &copy; {new Date().getFullYear()} {CV_DATA.name}. Built with Next.js, Three.js & GSAP.
      </div>
    </footer>
  );
}
